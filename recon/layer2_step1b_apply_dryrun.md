# Layer 2 Step 1b — Apply (DRY RUN)

Generated: 2026-04-27T21:32:08
Mode: **dry-run**
...
Would insert: action=`sa2_polygon_backfill_v1`, actor=`layer2_step1b_apply`, subject_type=`services`
...
```
  [0] layer2_step1b_apply
  [1] sa2_polygon_backfill_v1
  [2] services
  [3] 0
  [4] {"payload": {"candidates": 869, "null_sa2": 887, "unrecoverable_no_latlng": 18, "with_sa2": 17336}, "rows": 18223}
  [5] {"payload": {"assigned": 867, "coverage": 0.998902, "hit_rate": 0.997699, "method": "sjoin within (EPSG:4326 -> EPSG:7844)", "missed": 2, "null_sa2": 20, "sa2_features": 2473, "source_gpkg": "abs_data/ASGS_2021_Main_Structure_GDA2020.gpkg", "source_layer": "SA2_2021_AUST_GDA2020", "with_sa2": 182...
  [6] Layer 2 Step 1b: SA2 polygon point-in-polygon backfill. Assigned 867/869 candidates (99.77%). Misses: 2 (offshore/null-island, no AU SA2 polygon). NULL sa2_code: 887 -> 20 (of which 18 have no lat/lng and are unrecoverable here). Net SA2 coverage post-apply: 99.89%. Source: abs_data/ASGS_2021_Mai...
```
